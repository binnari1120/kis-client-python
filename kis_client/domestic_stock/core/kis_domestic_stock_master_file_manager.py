...
class KoreaInvestmentSecuritiesDomesticStockMasterFileManager:
    def __init__(self):
        self.kosfi_dataframe: Optional[pd.DataFrame] = None
        self.kosdaq_dataframe: Optional[pd.DataFrame] = None
    ...
    def _download_kospi_master_file(self):
        ...
        urllib.request.urlretrieve("https://new.real.download.dws.co.kr/common/master/kospi_code.mst.zip",
                                   self._saving_directory + "\\kospi_code.zip")
    ...
    def _get_kospi_master_dataframe(self):
        self._download_kospi_master_file()

        file_name = self._saving_directory + "\\kospi_code.mst"
        tmp_fil1 = self._saving_directory + "\\kospi_code_part1.tmp"
        tmp_fil2 = self._saving_directory + "\\kospi_code_part2.tmp"
    ...
    def _download_kosdaq_master_file(self):
        ...
        urllib.request.urlretrieve("https://new.real.download.dws.co.kr/common/master/kosdaq_code.mst.zip",
                                   self._saving_directory + "\\kosdaq_code.zip")
    ...
    def _get_kosdaq_master_dataframe(self):
        self._download_kosdaq_master_file()

        file_name = self._saving_directory + "\\kosdaq_code.mst"
        tmp_fil1 = self._saving_directory + "\\kosdaq_code_part1.tmp"
        tmp_fil2 = self._saving_directory + "\\kosdaq_code_part2.tmp"
